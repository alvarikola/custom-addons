...
class ListaTareas(http.Controller):
    ...
    def index(self, **kw):
        return "Hello, world DAM2, YOEL NO BEBE"
    ...
    @http.route('/lista_tareas/lista_tareas/listado', type='http', auth='public', methods=['GET'], csrf=False)
    def listado_tarea(self, **kw):
